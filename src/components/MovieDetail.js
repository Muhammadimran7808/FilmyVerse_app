...
const MovieDetail = () => {
    ...
    return (
        <div className='w-full px-6 pt-10 md:px-20 flex flex-col md:flex-row gap-7 md:gap-10 justify-center      max-md:items-center'>
            {
                loading ? <div className='mt-60'><ThreeDots color='#fff' /></div> :
                    <>
                        <img className=' md:sticky top-32 w-full h-80 md:w-72 md:h-96' src={data.image} alt="" />
